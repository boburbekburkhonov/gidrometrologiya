...
export type yesterdayDataStatisticDocument = HydratedDocument<YesterdayDataStatistic>;

@Schema({ collection: 'yesterday_data_statistic' })
export class YesterdayDataStatistic {
  @Prop({
...
export const yesterdayDataStatisticSchema = SchemaFactory.createForClass(YesterdayDataStatistic);
