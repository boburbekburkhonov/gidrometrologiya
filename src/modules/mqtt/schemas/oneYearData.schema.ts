...
export type oneYearDataDocument = HydratedDocument<oneYearData>;

@Schema({ collection: 'one_year_data' })
...
export const oneYearDatachema = SchemaFactory.createForClass(oneYearData);
